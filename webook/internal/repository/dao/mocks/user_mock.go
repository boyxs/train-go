...
//
//	mockgen -source=./repository/dao/user.go -package=daomocks -destination=./repository/dao/mocks/user_mock.go
//
...
func (m *MockUserDAO) Update(ctx context.Context, user dao.User) (dao.User, error) {
	m.ctrl.T.Helper()
