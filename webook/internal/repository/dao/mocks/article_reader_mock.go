...
// Source: ./repository/dao/article_reader.go
//
// Generated by this command:
//
//	mockgen -source=./repository/dao/article_reader.go -package=daomocks -destination=./repository/dao/mocks/article_reader_mock.go
//
