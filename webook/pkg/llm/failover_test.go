...
func makeCh() <-chan llm.StreamChunk {
...
func TestFailoverClient_ChatStream(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			f := llm.NewFailoverClient(tc.mock(ctrl), logger.NewNopLogger())
...
func TestFailoverClient_Concurrent(t *testing.T) {
	...
	f := llm.NewFailoverClient([]llm.Client{c0}, logger.NewNopLogger())
