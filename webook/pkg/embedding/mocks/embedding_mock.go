...
// Source: ./embedding/types.go
//
// Generated by this command:
//
//	mockgen -source=./embedding/types.go -package=embmocks -destination=./embedding/mocks/embedding_mock.go
//

// Package embmocks is a generated GoMock package.
package embmocks
