...
// InitGRPCServer 组装 gRPC server 并注册 TagService，由 main 起 goroutine 监听。
func InitGRPCServer(tagSrv *taggrpc.TagServer, client *etcdv3.Client, l logger.LoggerX, tp trace.TracerProvider) *grpcx.Server {
	...
	tagv1.RegisterTagServiceServer(srv.Server, tagSrv)
