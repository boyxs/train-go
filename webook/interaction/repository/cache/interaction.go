...
type InteractionCache interface {
	IncrReadCntIfPresent(ctx context.Context, biz string, bizId int64, n int64) error
...
func (c *RedisInteractionCache) IncrReadCntIfPresent(ctx context.Context, biz string, bizId int64, n int64) error {
